  ...
  <section class="relative bg-[#660000] overflow-hidden">
    ...
    >
      ...
      <swiper
        ...
        :grabCursor="true"
        :centeredSlides="true"
        :loop="computedSlides.length > 2"
        :initialSlide="0"
        :watchSlidesProgress="true"
        :coverflowEffect="coverflow"
        :loopedSlides="computedSlides.length"
...
const computedSlides = computed(() => {
  ...
  // Nhân bản mảng 3 lần để tạo cảm giác infinite scroll
  // [original, clone1, clone2]
  const originalSlides = props.slides;
  return [...originalSlides, ...originalSlides, ...originalSlides];
});
